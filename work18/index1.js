...
var pageList = new PageList({
    ...
    onChange: function () {
        // comment.ajax('http://localhost:8080/ajax?page=' + this.page, function () {   //调试通过app.js并截图后，注释本行
        comment.ajax('http://139.9.81.203:8090/ajax?page=' + this.page, function () {   //调试通过app.js并截图后，取消本行注释
